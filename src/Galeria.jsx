...
function Galeria() {
  return (
    <div className="bg-black flex justify-center items-center flex-col">
      <Nadpis nadpis="Galéria" />
      <div className="w-full h-32 text-justify text-white overflow-auto">
        ...
        modification/improvement from reviewers are published first. To quickly
        get your articles reviewed, please refer existing articles, their
        formatting style, coding style, and try to make you are close to them.
        In case you are a beginner, you may refer Guidelines to write an Article
      </div>
    </div>
  );
}
